...
const projects = [
  ...
  },
  {
    ...
    category: 'Static Website',
    description: 'Professional static website for Sharma Associates, showcasing tax and legal consulting services with a clean modern design.',
    image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=600&h=400&fit=crop',
    technologies: ['React', 'Tailwind CSS', 'JavaScript'],
    liveUrl: 'https://advocate-dinesh.vercel.app/',
    githubUrl: '#',
    accent: 'from-sky-500 to-cyan-400',
  },
  {
    title: 'BLGC Professional Beauty Care',
    category: 'Static Website',
    description: 'Elegant static website for BLGC Professional Beauty Care, featuring services, salon details, and appointments information.',
    image: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=600&h=400&fit=crop',
    technologies: ['HTML', 'CSS', 'JavaScript'],
    liveUrl: 'https://blgc.in',
    githubUrl: '#',
